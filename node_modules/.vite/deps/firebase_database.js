...
var AppCheckTokenProvider = class {
  constructor(app, appCheckProvider) {
    ...
    this.appCheck = appCheckProvider == null ? void 0 : appCheckProvider.getImmediate({ optional: true });
    if (!this.appCheck) {
  ...
  addTokenChangeListener(listener) {
    var _a;
    (_a = this.appCheckProvider) == null ? void 0 : _a.get().then((appCheck) => appCheck.addTokenListener(listener));
  }
...
function runTransaction(ref2, transactionUpdate, options) {
  ...
  const applyLocally = (options == null ? void 0 : options.applyLocally) ?? true;
  const deferred = new Deferred();
